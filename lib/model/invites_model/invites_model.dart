...
invitesModelFromJson(String str) => InvitesModel.fromJson(json.decode(str));

String invitesModelToJson(InvitesModel data) => json.encode(data.toJson());
...
class InvitesModel {
  ...
  factory InvitesModel.fromJson(Map<String, dynamic> json) => InvitesModel(
...
class Contact {
  ...
  factory Contact.fromJson(Map<String, dynamic> json) => Contact(
        ...
        contactAddressLine1: json["contact_address_line_1"] == null
            ? null
            : json["contact_address_line_1"],
        contactAddressLine2: json["contact_address_line_2"] == null
            ? null
            : json["contact_address_line_2"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "contact_address_line_1":
            contactAddressLine1 == null ? null : contactAddressLine1,
        "contact_address_line_2":
            contactAddressLine2 == null ? null : contactAddressLine2,
